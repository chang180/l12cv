...
- 履歷列印優化第一版已完成，公開履歷提供列印按鈕，列印版面會隱藏導覽與頁尾、移除陰影並套用 A4 邊界。
- 多種格式支援第一版已完成，新增 `@{slug}/docx`、PHPWord DOCX 產生器與公開履歷 DOCX 下載入口。
- 批次匯出第一版已完成，新增 `@{slug}/exports` ZIP 下載，內含同一份公開履歷的 PDF 與 DOCX。
- 作品集多媒體支援第一版已完成，新增 `projects.media_type`、`projects.media_url`、編輯表單欄位、公開列表標記與詳情頁播放器。
- 作品集分類管理第一版已完成，新增 `projects.category`、編輯表單欄位、管理列表、公開列表與詳情頁分類標記。
- 作品集標籤系統第一版已完成，新增 `projects.tags`、編輯表單欄位、標籤清理、管理列表、公開履歷專案卡、公開作品集與詳情頁標籤展示。
- 作品集搜尋功能第一版已完成，公開作品集可使用 `q`、`category`、`tag` 查詢參數，比對作品名稱、描述、分類、技術與標籤。
